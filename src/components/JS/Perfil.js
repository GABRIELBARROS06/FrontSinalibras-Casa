...
function PerfilAluno() {
  const [nomeAluno, setNomeAluno] = useState('Carregando...');
  ...
  useEffect(() => {
    ...
    async function buscarAlunoLogado() {
      try {
        ...
        const response = await fetch(`${BASE_URL}/v1/sinalibras/aluno/:id`); // Endpoint adequado
        ...
        setNomeAluno('Erro ao carregar o nome');
      }
    }
